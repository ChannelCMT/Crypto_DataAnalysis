...
if __name__ == '__main__':
    ...
    mpf.plot(dataCoin1.loc[endTime-timedelta(days=6):endTime], type='candle',style='binance', figsize=(20,8), tight_layout=True, savefig=saveCoin1) 
    mpf.plot(dataCoin2.loc[endTime-timedelta(days=6):endTime], type='candle',style='binance', figsize=(20,8), tight_layout=True, savefig=saveCoin2)
    # save the sheet
